...
(defn documentation []
  [:div (heading "Documentation"
                 (p "As being inspired by Tailwind CSS library - our documentation implements the same logic.")
                 (p "Table of contents:")
                 (p "Accessibibility.")
                 (p "Background.")
                 (p "Border.")
...
(def components {:about (about)
                 :installation (installation)
                 :documentation (documentation)})

(defn render-default [component-key]
  (component-key components))

(defn render-doc [component-key]
